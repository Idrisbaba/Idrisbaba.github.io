...
![Figure 1: Maps of NDVI values](assets/TCT1.png)
figure 1 displays four maps showing the spatial distribution of the TCT–greenness component values from 2020-2021

![Figure 2: Maps of NDVI values](assets/TCT2.png)
This figure presents four corresponding maps showing the spatial distribution of NDVI values for the exact same dates as in Figure 1


## New Tasseled Cap Classification Technique using Landsat-8 OLI Image Bands
While our previous discussion used sentinel 2 imagery to map changes in forest vegetation over time in the Natural Park “Blue Stones this in contary used
